...
baseurl = "https://www.nuqaclothing.com"
filename = './nuqastore.csv'
headers = {'User-Agent': GET_UA()}
webpage_to_extract = "https://www.nuqaclothing.com"
categories_name = "collections"
subdirectory ="/collections"
#Can be "http" or "/"
starts_with = '/'
#if it is more than one, it has to be a list
products_tags = ["grid-link text-center","grid-link text-center"]
#--------------------------------------------#
name_tag = "h1"
name_class = "name"
price_tag = 'span'
price_class = "product-single__price"
description_tag = 'div'
description_class = "tab-titulo"
